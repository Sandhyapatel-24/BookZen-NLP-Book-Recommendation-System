...
# =========================================================
# BOOKZEN ADMIN ENDPOINT COMPATIBILITY
# =========================================================

@app.route("/admin/books/add", methods=["GET", "POST"], endpoint="admin_books_add_compat")
def _admin_books_add_compat():
    return admin_books_add()


@app.route("/admin/books/edit/<int:book_id>", methods=["GET", "POST"],
           endpoint="admin_books_edit_compat")
def _admin_books_edit_compat(book_id):
    return admin_books_edit(book_id)


@app.route("/admin/books/delete/<int:book_id>", methods=["GET", "POST"],
           endpoint="admin_books_delete_compat")
def _admin_books_delete_compat(book_id):
    return admin_books_delete(book_id)
